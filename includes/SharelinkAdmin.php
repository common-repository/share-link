...
class SharelinkAdmin {
    ...
    public static function stylesAndScripts($hook) {
        if ($hook == "share-link_page_sharelink-setting" || $hook == "toplevel_page_sharelink" || $hook == "admin_page_sharelink-error-403") {
            ...
            wp_register_style('sharelink-jquery-ui', plugin_dir_url(__FILE__) . '../assets/css/jquery-ui.min.css');
            ...
            wp_enqueue_script('jQueryUI', plugin_dir_url(__FILE__) . '../assets/js/jquery-ui.min.js', ['jquery']);
