            ...
            <?php foreach ($widgets as $w) : ?>
                ...
                <span><i data-clipboard-text="[sharelink <?=$w['uuid']?>]" id="copy_clipboard<?=$w['uuid']?>" title="Copy to Clipboard" class="fa fa-clipboard copy-clipboard" aria-hidden="true"></i></span>
                    ...
                    <?php
                        ...
                        $embed = $script . "\n" . $iframe;
                    ?>
                    <h3 class="inline" style='margin-bottom: -10px;'>Embed Code: </h3><span>Place this directly in your WordPress template HTML code <span><i data-clipboard-text="<?=htmlspecialchars($embed)?>" class="fa fa-clipboard copy-clipboard" title="Copy to Clipboard" ></i></span></span>
